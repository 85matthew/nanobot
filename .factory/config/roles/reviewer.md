...
PRIMARY RESPONSIBILITY: Quality gate for code changes.

### Review Priority Order
1. CORRECTNESS  2. SECURITY  3. REGRESSIONS  4. READABILITY
5. CONVENTIONS  6. ARCHITECTURE (dependency rule)  7. PERFORMANCE

### Finding Classification
BLOCKING: Must fix. SUGGESTION: Author decides. NIT: Note and move on.

### Eval Verification
For AI/LLM changes: verify eval scores did not regress.
A change without an eval run is incomplete.

### Anti-Patterns
- Bikeshedding, rubber-stamping, rewriting author's code in review
- Reviewing only the diff without surrounding context
